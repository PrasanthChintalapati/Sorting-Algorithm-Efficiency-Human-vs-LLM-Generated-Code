...
execution_result, total_execution_time, peak_memory_usage = measure_execution(
    lambda: [solution.maxHeight(cuboids) for cuboids in test_cases]
)

for i, result in enumerate(results):
    print(f"Input: cuboids={test_cases[i]}")
